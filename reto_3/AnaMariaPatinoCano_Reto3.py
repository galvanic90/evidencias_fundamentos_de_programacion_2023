# -*- coding: utf-8 -*-
"""Reto 3_Ana María Patiño Cano.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1dUDS12Bu9ki8x1V6dyb8su0gN9-po1ss
"""
...
"""1. ¿Es posible que un condicional tenga más de una condición de acceso?
Sí es posible, para ello se usan por ejemplo "elif" y "else"

2. ¿Qué sucede si se hace uso de una sentencia break en un ciclo anidado (Un ciclo que se encuentra dentro de otro ciclo)?
En tal caso, break aplicaría unicamente para el bucle en el que se especifica, más no para la ejecución del bucle global o principal

3. ¿Dentro de los paréntesis de la función range() se pueden poner variables en vez de datos directamente?
Sí es posible poner variables como X, Y, Z, entre otros...siempre y cuando esas variables sean enteros o expresiones que evalúen a enteros.
"""